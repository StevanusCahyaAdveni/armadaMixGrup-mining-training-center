...
$query = "SELECT * FROM test_categorys";
    ...
    <section class="section">
        ...
        <div class="card p-2 mb-1 shadow-sm">
            <form method="GET" action="">
                <input type="hidden" name="hal" value="test_test-category">
                <div class="row g-1">
                    <div class="col-10">
                        ...
                        foreach ($pagination['data'] as $row): ?>
                            <tr class="pt-1 pb-1">
                                ...
                                <td>
                                    ...
                                    <a href="actions/?hal=test_test-category&delete=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="actions/?hal=test_test-category" method="POST">
...
<script>
function upData(id, category_title) {
    document.getElementById('edit_id').value = id;
    document.getElementById('edit_category_title').value = category_title;
